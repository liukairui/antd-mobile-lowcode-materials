...
const productPath = `/antd-mobile-lowcode-materials@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('antd-mobile-lowcode-materials', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'antd-mobile-lowcode-materials': join(__dirname, '../src')
  },
  apiParser: {
    propFilter: (prop) => {
